...
export default function DoctorCard({ doctor }) {
  return (
    <article className="group flex flex-col h-full overflow-hidden rounded-2xl glass-card border border-border/50 shadow-md transition-all duration-500 hover:-translate-y-2 hover:border-primary/40 hover:shadow-xl hover:shadow-primary/15 relative">
      ...
      <div className="relative h-60 shrink-0 overflow-hidden bg-muted z-0 [mask-image:linear-gradient(to_bottom,black_85%,transparent_100%)]">
        <img
          src={
            doctor.profileImage ||
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-background/95 via-background/10 to-transparent mix-blend-normal opacity-90 group-hover:opacity-100 transition-opacity duration-500" />
